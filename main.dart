    ...
    try {
      for (int i = 0; i < total; i++) {
        ...
        try {
          ...
          // Tell Android's MediaStore/MediaScanner about the finished JPG so
          // it appears in Gallery/Photos while keeping the user's chosen folder.
...
void _applyNoise(img.Image image, int amount) {
  // Adjustable sensor/ISO-style luminance noise.
  // 0 = off; 100 = strongest setting.
  final random = math.Random(20260824);
  final strength = math.max(1, (amount * 0.30).round());

...
class _PhotoProcessorPageState extends State<PhotoProcessorPage> {
  ...
  Future<void> _loadSavedSettings() async {
    ...
    setState(() {
      ...
      _maxWidth = (prefs.getInt('maxWidth') ?? _maxWidth).clamp(500, 1600);
  ...
  List<Widget> _buildSettingsChildren() {
    return [
          ...
          if (_adjustmentMode == 0) ...[
            Slider(
              value: _maxWidth.toDouble().clamp(500, 1600),
              min: 500,
              max: 1600,
              divisions: 70,
              label: '$_maxWidth px',
          ...
          if (_adjustmentMode == 0)
            const Text(
              'Slider：500–1600 px，可快速拖動調整',
              style: TextStyle(fontSize: 12),
            )
          else
            const Text(
              '精調：500–1600 px，可用 −／＋ 或點擊數值輸入',
              style: TextStyle(fontSize: 12),
            ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _sectionTitle('輸出尺寸'),
          DropdownButtonFormField<int>(
            initialValue: [500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600]
                    .contains(_maxWidth)
                ? _maxWidth
                : 1600,
            decoration: const InputDecoration(
            ...
            items: const [
              DropdownMenuItem(value: 500, child: Text('500 px')),
              DropdownMenuItem(value: 600, child: Text('600 px')),
              DropdownMenuItem(value: 700, child: Text('700 px')),
              DropdownMenuItem(value: 800, child: Text('800 px')),
              DropdownMenuItem(value: 900, child: Text('900 px')),
              DropdownMenuItem(value: 1000, child: Text('1000 px')),
              DropdownMenuItem(value: 1100, child: Text('1100 px')),
              DropdownMenuItem(value: 1200, child: Text('1200 px')),
              DropdownMenuItem(value: 1300, child: Text('1300 px')),
              DropdownMenuItem(value: 1400, child: Text('1400 px')),
              DropdownMenuItem(value: 1500, child: Text('1500 px')),
...
Future<Uint8List> _processImageInIsolate(
  ...
  final maxWidth = (config['maxWidth'] as int).clamp(500, 1600).toInt();

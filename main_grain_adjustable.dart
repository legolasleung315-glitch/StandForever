...
Future<Uint8List> _processImageInIsolate(
  ...
  if (filterMode == 1) {
    ...
    image = img.colorOffset(image, red: -1, green: 0, blue: 3);
    // The Note 2 references have noticeably softer micro-detail. A radius-1
    // blur is intentionally small so the image is softened without looking
    // out of focus.

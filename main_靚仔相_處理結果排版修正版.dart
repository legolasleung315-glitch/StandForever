...
class _PhotoProcessorPageState extends State<PhotoProcessorPage> {
  ...
  Future<void> _deleteGeneratedImages() async {
    ...
    for (final path in List<String>.from(_resultFiles)) {
      try {
        ...
        // Continue deleting the remaining output files.
      }
    }
  ...
  Future<void> _showResults(String outputDirectory) async {
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) {
        final resultCount = _resultFiles.length;
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: resultCount + errorCount,
                    itemBuilder: (context, index) {
                      ...
                      final error = _errors[index - resultCount];
                      return ListTile(
                        dense: true,
                        contentPadding: EdgeInsets.zero,
            ...
            Align(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  if (resultCount > 0)
                    FilledButton.icon(
                      onPressed: _deleteGeneratedImages,
